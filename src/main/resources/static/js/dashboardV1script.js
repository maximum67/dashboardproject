function myFunctionV1(dashboardParamId, periodValue, typeline_select, dashboardParam) {
    ...
    let sumxy = 0;
    let sumy = 0;
    let colors = ['#939a7a', '#aba9a9', '#8abe4b', '#c2d038',
                  '#AFB42B', '#7797a8', '#a4a4a4', '#c0cead',
                  '#03A9F4', '#a69f82'];
    ...
    axios.get('/api/dashboard/V2/' + dashboardParamId + '/' + periodValue)
        .then((response) => {
            ...
            if (typeline_select === 'Область') {
                Highcharts.chart('container'+dashboardParamId, {
                    chart: {
                        type: "area"
                    },
                    credits: {
